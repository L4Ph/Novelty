...
- **閲覧履歴:** お客様が本アプリで閲覧した小説の提供サイト（小説家になろう／カクヨム）、作品IDと話数。この情報は、お客様のデバイス内にのみ保存され、外部に送信されることはありません。
...
- **カクヨム:** 公開HTML（作品・目次・本文・検索・ランキング）を取得するために利用します。robots.txtを遵守し、レート制限を設けてアクセスします。
  - [KADOKAWA プライバシーポリシー](https://group.kadokawa.co.jp/privacy_policy/main.html)
