...
class MockCanvas extends Mock implements Canvas {
  Rect clipRect = Rect.largest;

  @override
  Rect getLocalClipBounds() => clipRect;
}

class MockPaintable extends Mock implements Paintable {
  @override
  double get baseWidth => 20.0;
  
  @override
  double get width => 20.0;
...
void main() {
  test('TategakiPainter culls invisible columns', () {
    ...
    canvas.clipRect = const Rect.fromLTWH(0, 0, 160, 600);
    ...
    canvas.clipRect = const Rect.fromLTWH(0, 0, 60, 600);
    painter.paint(canvas, const Size(160, 600));
    
    // Verify Col 3 and 4 are painted
    verify(mockItems[3].paint(canvas, argThat(isA<Offset>()))).called(1); // Col 3
    verify(mockItems[4].paint(canvas, argThat(isA<Offset>()))).called(1); // Col 4
