...
@HtmlEscapeConverter() String? get story;/// 小説タイプ。
///
/// [1] 連載
/// [2] 短編
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,title,ncode,writer,userId,story,novelType,end,generalAllNo,genre,keyword,generalFirstup,generalLastup,globalPoint,dailyPoint,weeklyPoint,monthlyPoint,quarterPoint,yearlyPoint,favNovelCnt,impressionCnt,reviewCnt,allPoint,allHyokaCnt,sasieCnt,kaiwaritu,novelupdatedAt,updatedAt,const DeepCollectionEquality().hash(episodes),isr15,isbl,isgl,iszankoku,istensei,istenni,isPrivate]);

@override
String toString() {
  return 'NovelInfo(title: $title, ncode: $ncode, writer: $writer, userId: $userId, story: $story, novelType: $novelType, end: $end, generalAllNo: $generalAllNo, genre: $genre, keyword: $keyword, generalFirstup: $generalFirstup, generalLastup: $generalLastup, globalPoint: $globalPoint, dailyPoint: $dailyPoint, weeklyPoint: $weeklyPoint, monthlyPoint: $monthlyPoint, quarterPoint: $quarterPoint, yearlyPoint: $yearlyPoint, favNovelCnt: $favNovelCnt, impressionCnt: $impressionCnt, reviewCnt: $reviewCnt, allPoint: $allPoint, allHyokaCnt: $allHyokaCnt, sasieCnt: $sasieCnt, kaiwaritu: $kaiwaritu, novelupdatedAt: $novelupdatedAt, updatedAt: $updatedAt, episodes: $episodes, isr15: $isr15, isbl: $isbl, isgl: $isgl, iszankoku: $iszankoku, istensei: $istensei, istenni: $istenni, isPrivate: $isPrivate)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HtmlEscapeConverter()  String? title,  String? ncode, @HtmlEscapeConverter()  String? writer, @StringToIntConverter()@JsonKey(name: 'userid')  int? userId, @HtmlEscapeConverter()  String? story, @StringToIntConverter()@JsonKey(name: 'novel_type')  int? novelType, @StringToIntConverter()  int? end, @StringToIntConverter()@JsonKey(name: 'general_all_no')  int? generalAllNo, @StringToIntConverter()  int? genre, @HtmlEscapeConverter()  String? keyword, @JsonKey(name: 'general_firstup')  String? generalFirstup, @JsonKey(name: 'general_lastup')  String? generalLastup, @StringToIntConverter()@JsonKey(name: 'global_point')  int? globalPoint, @StringToIntConverter()@JsonKey(name: 'daily_point')  int? dailyPoint, @StringToIntConverter()@JsonKey(name: 'weekly_point')  int? weeklyPoint, @StringToIntConverter()@JsonKey(name: 'monthly_point')  int? monthlyPoint, @StringToIntConverter()@JsonKey(name: 'quarter_point')  int? quarterPoint, @StringToIntConverter()@JsonKey(name: 'yearly_point')  int? yearlyPoint, @StringToIntConverter()@JsonKey(name: 'fav_novel_cnt')  int? favNovelCnt, @StringToIntConverter()@JsonKey(name: 'impression_cnt')  int? impressionCnt, @StringToIntConverter()@JsonKey(name: 'review_cnt')  int? reviewCnt, @StringToIntConverter()@JsonKey(name: 'all_point')  int? allPoint, @StringToIntConverter()@JsonKey(name: 'all_hyoka_cnt')  int? allHyokaCnt, @StringToIntConverter()@JsonKey(name: 'sasie_cnt')  int? sasieCnt, @StringToIntConverter()  int? kaiwaritu, @StringToIntConverter()@JsonKey(name: 'novelupdated_at')  int? novelupdatedAt, @StringToIntConverter()@JsonKey(name: 'updated_at')  int? updatedAt,  List<Episode>? episodes, @StringToIntConverter()  int? isr15, @StringToIntConverter()  int? isbl, @StringToIntConverter()  int? isgl, @StringToIntConverter()  int? iszankoku, @StringToIntConverter()  int? istensei, @StringToIntConverter()  int? istenni,  bool? isPrivate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NovelInfo() when $default != null:
return $default(_that.title,_that.ncode,_that.writer,_that.userId,_that.story,_that.novelType,_that.end,_that.generalAllNo,_that.genre,_that.keyword,_that.generalFirstup,_that.generalLastup,_that.globalPoint,_that.dailyPoint,_that.weeklyPoint,_that.monthlyPoint,_that.quarterPoint,_that.yearlyPoint,_that.favNovelCnt,_that.impressionCnt,_that.reviewCnt,_that.allPoint,_that.allHyokaCnt,_that.sasieCnt,_that.kaiwaritu,_that.novelupdatedAt,_that.updatedAt,_that.episodes,_that.isr15,_that.isbl,_that.isgl,_that.iszankoku,_that.istensei,_that.istenni,_that.isPrivate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HtmlEscapeConverter()  String? title,  String? ncode, @HtmlEscapeConverter()  String? writer, @StringToIntConverter()@JsonKey(name: 'userid')  int? userId, @HtmlEscapeConverter()  String? story, @StringToIntConverter()@JsonKey(name: 'novel_type')  int? novelType, @StringToIntConverter()  int? end, @StringToIntConverter()@JsonKey(name: 'general_all_no')  int? generalAllNo, @StringToIntConverter()  int? genre, @HtmlEscapeConverter()  String? keyword, @JsonKey(name: 'general_firstup')  String? generalFirstup, @JsonKey(name: 'general_lastup')  String? generalLastup, @StringToIntConverter()@JsonKey(name: 'global_point')  int? globalPoint, @StringToIntConverter()@JsonKey(name: 'daily_point')  int? dailyPoint, @StringToIntConverter()@JsonKey(name: 'weekly_point')  int? weeklyPoint, @StringToIntConverter()@JsonKey(name: 'monthly_point')  int? monthlyPoint, @StringToIntConverter()@JsonKey(name: 'quarter_point')  int? quarterPoint, @StringToIntConverter()@JsonKey(name: 'yearly_point')  int? yearlyPoint, @StringToIntConverter()@JsonKey(name: 'fav_novel_cnt')  int? favNovelCnt, @StringToIntConverter()@JsonKey(name: 'impression_cnt')  int? impressionCnt, @StringToIntConverter()@JsonKey(name: 'review_cnt')  int? reviewCnt, @StringToIntConverter()@JsonKey(name: 'all_point')  int? allPoint, @StringToIntConverter()@JsonKey(name: 'all_hyoka_cnt')  int? allHyokaCnt, @StringToIntConverter()@JsonKey(name: 'sasie_cnt')  int? sasieCnt, @StringToIntConverter()  int? kaiwaritu, @StringToIntConverter()@JsonKey(name: 'novelupdated_at')  int? novelupdatedAt, @StringToIntConverter()@JsonKey(name: 'updated_at')  int? updatedAt,  List<Episode>? episodes, @StringToIntConverter()  int? isr15, @StringToIntConverter()  int? isbl, @StringToIntConverter()  int? isgl, @StringToIntConverter()  int? iszankoku, @StringToIntConverter()  int? istensei, @StringToIntConverter()  int? istenni,  bool? isPrivate)  $default,) {final _that = this;
switch (_that) {
case _NovelInfo():
return $default(_that.title,_that.ncode,_that.writer,_that.userId,_that.story,_that.novelType,_that.end,_that.generalAllNo,_that.genre,_that.keyword,_that.generalFirstup,_that.generalLastup,_that.globalPoint,_that.dailyPoint,_that.weeklyPoint,_that.monthlyPoint,_that.quarterPoint,_that.yearlyPoint,_that.favNovelCnt,_that.impressionCnt,_that.reviewCnt,_that.allPoint,_that.allHyokaCnt,_that.sasieCnt,_that.kaiwaritu,_that.novelupdatedAt,_that.updatedAt,_that.episodes,_that.isr15,_that.isbl,_that.isgl,_that.iszankoku,_that.istensei,_that.istenni,_that.isPrivate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HtmlEscapeConverter()  String? title,  String? ncode, @HtmlEscapeConverter()  String? writer, @StringToIntConverter()@JsonKey(name: 'userid')  int? userId, @HtmlEscapeConverter()  String? story, @StringToIntConverter()@JsonKey(name: 'novel_type')  int? novelType, @StringToIntConverter()  int? end, @StringToIntConverter()@JsonKey(name: 'general_all_no')  int? generalAllNo, @StringToIntConverter()  int? genre, @HtmlEscapeConverter()  String? keyword, @JsonKey(name: 'general_firstup')  String? generalFirstup, @JsonKey(name: 'general_lastup')  String? generalLastup, @StringToIntConverter()@JsonKey(name: 'global_point')  int? globalPoint, @StringToIntConverter()@JsonKey(name: 'daily_point')  int? dailyPoint, @StringToIntConverter()@JsonKey(name: 'weekly_point')  int? weeklyPoint, @StringToIntConverter()@JsonKey(name: 'monthly_point')  int? monthlyPoint, @StringToIntConverter()@JsonKey(name: 'quarter_point')  int? quarterPoint, @StringToIntConverter()@JsonKey(name: 'yearly_point')  int? yearlyPoint, @StringToIntConverter()@JsonKey(name: 'fav_novel_cnt')  int? favNovelCnt, @StringToIntConverter()@JsonKey(name: 'impression_cnt')  int? impressionCnt, @StringToIntConverter()@JsonKey(name: 'review_cnt')  int? reviewCnt, @StringToIntConverter()@JsonKey(name: 'all_point')  int? allPoint, @StringToIntConverter()@JsonKey(name: 'all_hyoka_cnt')  int? allHyokaCnt, @StringToIntConverter()@JsonKey(name: 'sasie_cnt')  int? sasieCnt, @StringToIntConverter()  int? kaiwaritu, @StringToIntConverter()@JsonKey(name: 'novelupdated_at')  int? novelupdatedAt, @StringToIntConverter()@JsonKey(name: 'updated_at')  int? updatedAt,  List<Episode>? episodes, @StringToIntConverter()  int? isr15, @StringToIntConverter()  int? isbl, @StringToIntConverter()  int? isgl, @StringToIntConverter()  int? iszankoku, @StringToIntConverter()  int? istensei, @StringToIntConverter()  int? istenni,  bool? isPrivate)?  $default,) {final _that = this;
switch (_that) {
case _NovelInfo() when $default != null:
return $default(_that.title,_that.ncode,_that.writer,_that.userId,_that.story,_that.novelType,_that.end,_that.generalAllNo,_that.genre,_that.keyword,_that.generalFirstup,_that.generalLastup,_that.globalPoint,_that.dailyPoint,_that.weeklyPoint,_that.monthlyPoint,_that.quarterPoint,_that.yearlyPoint,_that.favNovelCnt,_that.impressionCnt,_that.reviewCnt,_that.allPoint,_that.allHyokaCnt,_that.sasieCnt,_that.kaiwaritu,_that.novelupdatedAt,_that.updatedAt,_that.episodes,_that.isr15,_that.isbl,_that.isgl,_that.iszankoku,_that.istensei,_that.istenni,_that.isPrivate);case _:
  return null;
