...
@JsonKey(name: 'genre') List<String>? get genreId;/// 除外ジャンル。
///
...
/// なろうでは [type] を使うため、なろうAPIには送信しない。
 String? get serialStatus;/// 総文字数範囲（カクヨム専用）。
///
...
/// なろうAPIには送信しない。
 String? get totalCharacterCountRange;/// 文体。
///
/// ハイフン(-)記号で区切ればOR検索ができる。
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NovelSearchQuery&&(identical(other.source, source) || other.source == source)&&(identical(other.word, word) || other.word == word)&&(identical(other.notword, notword) || other.notword == notword)&&(identical(other.title, title) || other.title == title)&&(identical(other.ex, ex) || other.ex == ex)&&(identical(other.keyword, keyword) || other.keyword == keyword)&&(identical(other.wname, wname) || other.wname == wname)&&const DeepCollectionEquality().equals(other.biggenre, biggenre)&&const DeepCollectionEquality().equals(other.notbiggenre, notbiggenre)&&const DeepCollectionEquality().equals(other.genreId, genreId)&&const DeepCollectionEquality().equals(other.notgenre, notgenre)&&const DeepCollectionEquality().equals(other.userid, userid)&&(identical(other.isr15, isr15) || other.isr15 == isr15)&&(identical(other.isbl, isbl) || other.isbl == isbl)&&(identical(other.isgl, isgl) || other.isgl == isgl)&&(identical(other.iszankoku, iszankoku) || other.iszankoku == iszankoku)&&(identical(other.istensei, istensei) || other.istensei == istensei)&&(identical(other.istenni, istenni) || other.istenni == istenni)&&(identical(other.istt, istt) || other.istt == istt)&&(identical(other.notr15, notr15) || other.notr15 == notr15)&&(identical(other.notbl, notbl) || other.notbl == notbl)&&(identical(other.notgl, notgl) || other.notgl == notgl)&&(identical(other.notzankoku, notzankoku) || other.notzankoku == notzankoku)&&(identical(other.nottensei, nottensei) || other.nottensei == nottensei)&&(identical(other.nottenni, nottenni) || other.nottenni == nottenni)&&(identical(other.minlen, minlen) || other.minlen == minlen)&&(identical(other.maxlen, maxlen) || other.maxlen == maxlen)&&(identical(other.length, length) || other.length == length)&&(identical(other.kaiwaritu, kaiwaritu) || other.kaiwaritu == kaiwaritu)&&(identical(other.sasie, sasie) || other.sasie == sasie)&&(identical(other.mintime, mintime) || other.mintime == mintime)&&(identical(other.maxtime, maxtime) || other.maxtime == maxtime)&&(identical(other.time, time) || other.time == time)&&const DeepCollectionEquality().equals(other.ncode, ncode)&&(identical(other.type, type) || other.type == type)&&(identical(other.serialStatus, serialStatus) || other.serialStatus == serialStatus)&&(identical(other.totalCharacterCountRange, totalCharacterCountRange) || other.totalCharacterCountRange == totalCharacterCountRange)&&const DeepCollectionEquality().equals(other.buntai, buntai)&&(identical(other.stop, stop) || other.stop == stop)&&(identical(other.lastup, lastup) || other.lastup == lastup)&&(identical(other.lastupdate, lastupdate) || other.lastupdate == lastupdate)&&(identical(other.ispickup, ispickup) || other.ispickup == ispickup)&&(identical(other.order, order) || other.order == order)&&(identical(other.lim, lim) || other.lim == lim)&&(identical(other.st, st) || other.st == st));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,source,word,notword,title,ex,keyword,wname,const DeepCollectionEquality().hash(biggenre),const DeepCollectionEquality().hash(notbiggenre),const DeepCollectionEquality().hash(genreId),const DeepCollectionEquality().hash(notgenre),const DeepCollectionEquality().hash(userid),isr15,isbl,isgl,iszankoku,istensei,istenni,istt,notr15,notbl,notgl,notzankoku,nottensei,nottenni,minlen,maxlen,length,kaiwaritu,sasie,mintime,maxtime,time,const DeepCollectionEquality().hash(ncode),type,serialStatus,totalCharacterCountRange,const DeepCollectionEquality().hash(buntai),stop,lastup,lastupdate,ispickup,order,lim,st]);

@override
String toString() {
  return 'NovelSearchQuery(source: $source, word: $word, notword: $notword, title: $title, ex: $ex, keyword: $keyword, wname: $wname, biggenre: $biggenre, notbiggenre: $notbiggenre, genreId: $genreId, notgenre: $notgenre, userid: $userid, isr15: $isr15, isbl: $isbl, isgl: $isgl, iszankoku: $iszankoku, istensei: $istensei, istenni: $istenni, istt: $istt, notr15: $notr15, notbl: $notbl, notgl: $notgl, notzankoku: $notzankoku, nottensei: $nottensei, nottenni: $nottenni, minlen: $minlen, maxlen: $maxlen, length: $length, kaiwaritu: $kaiwaritu, sasie: $sasie, mintime: $mintime, maxtime: $maxtime, time: $time, ncode: $ncode, type: $type, serialStatus: $serialStatus, totalCharacterCountRange: $totalCharacterCountRange, buntai: $buntai, stop: $stop, lastup: $lastup, lastupdate: $lastupdate, ispickup: $ispickup, order: $order, lim: $lim, st: $st)';
}
...
@useResult
$Res call({
 NovelSource source, String? word, String? notword, bool title, bool ex, bool keyword, bool wname, List<int>? biggenre, List<int>? notbiggenre,@JsonKey(name: 'genre') List<String>? genreId, List<int>? notgenre, List<int>? userid, bool isr15, bool isbl, bool isgl, bool iszankoku, bool istensei, bool istenni, bool istt, bool notr15, bool notbl, bool notgl, bool notzankoku, bool nottensei, bool nottenni, int? minlen, int? maxlen, String? length, String? kaiwaritu, String? sasie, int? mintime, int? maxtime, String? time, List<String>? ncode, String? type, String? serialStatus, String? totalCharacterCountRange, List<int>? buntai, int? stop, String? lastup, String? lastupdate, bool ispickup, String order, int lim, int st
});
...
/// Create a copy of NovelSearchQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? source = null,Object? word = freezed,Object? notword = freezed,Object? title = null,Object? ex = null,Object? keyword = null,Object? wname = null,Object? biggenre = freezed,Object? notbiggenre = freezed,Object? genreId = freezed,Object? notgenre = freezed,Object? userid = freezed,Object? isr15 = null,Object? isbl = null,Object? isgl = null,Object? iszankoku = null,Object? istensei = null,Object? istenni = null,Object? istt = null,Object? notr15 = null,Object? notbl = null,Object? notgl = null,Object? notzankoku = null,Object? nottensei = null,Object? nottenni = null,Object? minlen = freezed,Object? maxlen = freezed,Object? length = freezed,Object? kaiwaritu = freezed,Object? sasie = freezed,Object? mintime = freezed,Object? maxtime = freezed,Object? time = freezed,Object? ncode = freezed,Object? type = freezed,Object? serialStatus = freezed,Object? totalCharacterCountRange = freezed,Object? buntai = freezed,Object? stop = freezed,Object? lastup = freezed,Object? lastupdate = freezed,Object? ispickup = null,Object? order = null,Object? lim = null,Object? st = null,}) {
  return _then(_self.copyWith(
source: null == source ? _self.source : source // ignore: cast_nullable_to_non_nullable
as NovelSource,word: freezed == word ? _self.word : word // ignore: cast_nullable_to_non_nullable
...
as List<int>?,genreId: freezed == genreId ? _self.genreId : genreId // ignore: cast_nullable_to_non_nullable
as List<String>?,notgenre: freezed == notgenre ? _self.notgenre : notgenre // ignore: cast_nullable_to_non_nullable
...
as String?,serialStatus: freezed == serialStatus ? _self.serialStatus : serialStatus // ignore: cast_nullable_to_non_nullable
as String?,totalCharacterCountRange: freezed == totalCharacterCountRange ? _self.totalCharacterCountRange : totalCharacterCountRange // ignore: cast_nullable_to_non_nullable
...
class _NovelSearchQuery implements NovelSearchQuery {
  const _NovelSearchQuery({this.source = NovelSource.narou, this.word, this.notword, this.title = false, this.ex = false, this.keyword = false, this.wname = false, final  List<int>? biggenre, final  List<int>? notbiggenre, @JsonKey(name: 'genre') final  List<String>? genreId, final  List<int>? notgenre, final  List<int>? userid, this.isr15 = false, this.isbl = false, this.isgl = false, this.iszankoku = false, this.istensei = false, this.istenni = false, this.istt = false, this.notr15 = false, this.notbl = false, this.notgl = false, this.notzankoku = false, this.nottensei = false, this.nottenni = false, this.minlen, this.maxlen, this.length, this.kaiwaritu, this.sasie, this.mintime, this.maxtime, this.time, final  List<String>? ncode, this.type, this.serialStatus, this.totalCharacterCountRange, final  List<int>? buntai, this.stop, this.lastup, this.lastupdate, this.ispickup = false, this.order = 'new', this.lim = 20, this.st = 1}): _biggenre = biggenre,_notbiggenre = notbiggenre,_genreId = genreId,_notgenre = notgenre,_userid = userid,_ncode = ncode,_buntai = buntai;
...
/// サイト共通のジャンルID（文字列）。
/// なろうは [ジャンル一覧](https://dev.syosetu.com/man/api/#genre) のID文字列。
 final  List<String>? _genreId;
/// ジャンル。
///
/// サイト共通のジャンルID（文字列）。
/// なろうは [ジャンル一覧](https://dev.syosetu.com/man/api/#genre) のID文字列。
@override@JsonKey(name: 'genre') List<String>? get genreId {
...
///
/// なろうでは [type] を使うため、なろうAPIには送信しない。
@override final  String? serialStatus;
/// 総文字数範囲（カクヨム専用）。
///
/// カクヨム `/search` の `total_character_count_range` パラメータに対応する。
/// `20000-100000` のように最小値と最大値をハイフン(-)で区切る。
...
/// なろうでは [minlen] / [maxlen] / [length] を使うため、
/// なろうAPIには送信しない。
@override final  String? totalCharacterCountRange;
/// 文体。
///
/// ハイフン(-)記号で区切ればOR検索ができる。
/// * `1` - 字下げされておらず、連続改行が多い作品
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NovelSearchQuery&&(identical(other.source, source) || other.source == source)&&(identical(other.word, word) || other.word == word)&&(identical(other.notword, notword) || other.notword == notword)&&(identical(other.title, title) || other.title == title)&&(identical(other.ex, ex) || other.ex == ex)&&(identical(other.keyword, keyword) || other.keyword == keyword)&&(identical(other.wname, wname) || other.wname == wname)&&const DeepCollectionEquality().equals(other._biggenre, _biggenre)&&const DeepCollectionEquality().equals(other._notbiggenre, _notbiggenre)&&const DeepCollectionEquality().equals(other._genreId, _genreId)&&const DeepCollectionEquality().equals(other._notgenre, _notgenre)&&const DeepCollectionEquality().equals(other._userid, _userid)&&(identical(other.isr15, isr15) || other.isr15 == isr15)&&(identical(other.isbl, isbl) || other.isbl == isbl)&&(identical(other.isgl, isgl) || other.isgl == isgl)&&(identical(other.iszankoku, iszankoku) || other.iszankoku == iszankoku)&&(identical(other.istensei, istensei) || other.istensei == istensei)&&(identical(other.istenni, istenni) || other.istenni == istenni)&&(identical(other.istt, istt) || other.istt == istt)&&(identical(other.notr15, notr15) || other.notr15 == notr15)&&(identical(other.notbl, notbl) || other.notbl == notbl)&&(identical(other.notgl, notgl) || other.notgl == notgl)&&(identical(other.notzankoku, notzankoku) || other.notzankoku == notzankoku)&&(identical(other.nottensei, nottensei) || other.nottensei == nottensei)&&(identical(other.nottenni, nottenni) || other.nottenni == nottenni)&&(identical(other.minlen, minlen) || other.minlen == minlen)&&(identical(other.maxlen, maxlen) || other.maxlen == maxlen)&&(identical(other.length, length) || other.length == length)&&(identical(other.kaiwaritu, kaiwaritu) || other.kaiwaritu == kaiwaritu)&&(identical(other.sasie, sasie) || other.sasie == sasie)&&(identical(other.mintime, mintime) || other.mintime == mintime)&&(identical(other.maxtime, maxtime) || other.maxtime == maxtime)&&(identical(other.time, time) || other.time == time)&&const DeepCollectionEquality().equals(other._ncode, _ncode)&&(identical(other.type, type) || other.type == type)&&(identical(other.serialStatus, serialStatus) || other.serialStatus == serialStatus)&&(identical(other.totalCharacterCountRange, totalCharacterCountRange) || other.totalCharacterCountRange == totalCharacterCountRange)&&const DeepCollectionEquality().equals(other._buntai, _buntai)&&(identical(other.stop, stop) || other.stop == stop)&&(identical(other.lastup, lastup) || other.lastup == lastup)&&(identical(other.lastupdate, lastupdate) || other.lastupdate == lastupdate)&&(identical(other.ispickup, ispickup) || other.ispickup == ispickup)&&(identical(other.order, order) || other.order == order)&&(identical(other.lim, lim) || other.lim == lim)&&(identical(other.st, st) || other.st == st));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,source,word,notword,title,ex,keyword,wname,const DeepCollectionEquality().hash(_biggenre),const DeepCollectionEquality().hash(_notbiggenre),const DeepCollectionEquality().hash(_genreId),const DeepCollectionEquality().hash(_notgenre),const DeepCollectionEquality().hash(_userid),isr15,isbl,isgl,iszankoku,istensei,istenni,istt,notr15,notbl,notgl,notzankoku,nottensei,nottenni,minlen,maxlen,length,kaiwaritu,sasie,mintime,maxtime,time,const DeepCollectionEquality().hash(_ncode),type,serialStatus,totalCharacterCountRange,const DeepCollectionEquality().hash(_buntai),stop,lastup,lastupdate,ispickup,order,lim,st]);
...
/// Create a copy of NovelSearchQuery
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? source = null,Object? word = freezed,Object? notword = freezed,Object? title = null,Object? ex = null,Object? keyword = null,Object? wname = null,Object? biggenre = freezed,Object? notbiggenre = freezed,Object? genreId = freezed,Object? notgenre = freezed,Object? userid = freezed,Object? isr15 = null,Object? isbl = null,Object? isgl = null,Object? iszankoku = null,Object? istensei = null,Object? istenni = null,Object? istt = null,Object? notr15 = null,Object? notbl = null,Object? notgl = null,Object? notzankoku = null,Object? nottensei = null,Object? nottenni = null,Object? minlen = freezed,Object? maxlen = freezed,Object? length = freezed,Object? kaiwaritu = freezed,Object? sasie = freezed,Object? mintime = freezed,Object? maxtime = freezed,Object? time = freezed,Object? ncode = freezed,Object? type = freezed,Object? serialStatus = freezed,Object? totalCharacterCountRange = freezed,Object? buntai = freezed,Object? stop = freezed,Object? lastup = freezed,Object? lastupdate = freezed,Object? ispickup = null,Object? order = null,Object? lim = null,Object? st = null,}) {
...
as List<int>?,genreId: freezed == genreId ? _self._genreId : genreId // ignore: cast_nullable_to_non_nullable
as List<String>?,notgenre: freezed == notgenre ? _self._notgenre : notgenre // ignore: cast_nullable_to_non_nullable
