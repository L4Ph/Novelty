...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,source,word,notword,title,ex,keyword,wname,const DeepCollectionEquality().hash(_biggenre),const DeepCollectionEquality().hash(_notbiggenre),const DeepCollectionEquality().hash(_genreId),const DeepCollectionEquality().hash(_notgenre),const DeepCollectionEquality().hash(_userid),isr15,isbl,isgl,iszankoku,istensei,istenni,istt,notr15,notbl,notgl,notzankoku,nottensei,nottenni,minlen,maxlen,length,kaiwaritu,sasie,mintime,maxtime,time,const DeepCollectionEquality().hash(_ncode),type,const DeepCollectionEquality().hash(_buntai),stop,lastup,lastupdate,ispickup,order,lim,st]);
