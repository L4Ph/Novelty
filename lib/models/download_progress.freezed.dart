...
/// 現在ダウンロード中のエピソード数
 int get currentEpisode;/// 全エピソード数
 int get totalEpisodes;/// ダウンロード中かどうか
 bool get isDownloading;/// エラーメッセージ（ある場合）
...
@override
int get hashCode => Object.hash(runtimeType,currentEpisode,totalEpisodes,isDownloading,errorMessage);

@override
String toString() {
  return 'DownloadProgress(currentEpisode: $currentEpisode, totalEpisodes: $totalEpisodes, isDownloading: $isDownloading, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 int currentEpisode, int totalEpisodes, bool isDownloading, String? errorMessage
});
...
/// Create a copy of DownloadProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentEpisode = null,Object? totalEpisodes = null,Object? isDownloading = null,Object? errorMessage = freezed,}) {
  return _then(_self.copyWith(
currentEpisode: null == currentEpisode ? _self.currentEpisode : currentEpisode // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentEpisode,  int totalEpisodes,  bool isDownloading,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DownloadProgress() when $default != null:
return $default(_that.currentEpisode,_that.totalEpisodes,_that.isDownloading,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentEpisode,  int totalEpisodes,  bool isDownloading,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _DownloadProgress():
return $default(_that.currentEpisode,_that.totalEpisodes,_that.isDownloading,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentEpisode,  int totalEpisodes,  bool isDownloading,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _DownloadProgress() when $default != null:
return $default(_that.currentEpisode,_that.totalEpisodes,_that.isDownloading,_that.errorMessage);case _:
  return null;
...
class _DownloadProgress extends DownloadProgress {
  const _DownloadProgress({required this.currentEpisode, required this.totalEpisodes, required this.isDownloading, this.errorMessage}): super._();
...
/// Create a copy of DownloadProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentEpisode = null,Object? totalEpisodes = null,Object? isDownloading = null,Object? errorMessage = freezed,}) {
